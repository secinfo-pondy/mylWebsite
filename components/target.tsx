      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-sans-display text-slate-800 mb-3">We're experts and brand creators</h2>
              ...
              <ul className="space-y-6">
                <li>
                  <div className="flex items-center mb-4">
                    ...
                    <div className="h2 font-sans-display text-slate-800">79%</div>
                  </div>
                ...
                <li>
                  <div className="flex items-center mb-4">
                    ...
                    <div className="h2 font-sans-display text-slate-800">1M+</div>
                  </div>
                  <div className="text-slate-500 text-lg">Lorem ipsum is placeholder text used in the graphic, print, and publishing for previewing layouts.</div>
                </li>
                <li>
                  <div className="flex items-center mb-4">
                    ...
                    <div className="h2 font-sans-display text-slate-800">500K</div>
                  </div>
                  <div className="text-slate-500 text-lg">Lorem ipsum is placeholder text used in the graphic, print, and publishing for previewing layouts.</div>
                </li>
              </ul>
