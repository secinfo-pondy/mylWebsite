        ...
        <div className="py-12 md:pt-20 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-lg text-slate-500">
              <h2 className="h3 font-sans-display text-slate-800 mb-4">About Black Inc.</h2>
              <p className="mb-8">
              ...
              <h3 className="flex h4 font-sans-display text-slate-800 mb-4 lg:-ml-10">
              ...
              <h2 className="h3 font-sans-display text-slate-800 mb-4">Conclusion</h2>
              <p className="mb-8">
